...
이 프로젝트의 목적은 다음과 같다.   
1. 클래스101의 디자인 요소를 참고하여 사용자 중심의 깔끔하고 직관적인 인터페이스를 구현함으로써 사이트 전반의 가독성과 접근성을 향상시킨다.
2. 스와이프, D-day 카운트다운 등 인터랙티브 기능을 적용하여 사용자 참여도를 높이고, 학습 콘텐츠 탐색을 더욱 직관적이고 효율적으로 만든다.
3. 다양한 디바이스 환경에서도 일관된 사용 경험을 제공하기 위해 반응형 웹 디자인을 적용하고, 모바일 사용자의 접근성과 편의성을 강화한다.
